...
- **Data-view semantics (FACT-016, USER CONFIRMED):** Owner Overview = current LIVE operational activity only. Records tagged `origin:'july-import'` (FACT-008) are historical: available for reporting/reconciliation/audit views, excluded from live KPIs, and may appear combined with live figures only when the owner explicitly selects a Combined View (future TASK-026; UX spec in ai/UX_AUDIT.md UXF-001). Live-audit evidence (FACT-018, 2026-07-21): Owner → Documents observed showing 351 imported records / AED 159,692.26 across the five money categories with July references — historical availability confirmed. **Surface compliance matrix (code-traced 2026-07-21, FACT-019/020/021):** owner home KPIs ✓ clean (client appstate) · Muhammed assistant ✓ clean (client appstate; observed zeros FACT-019) · EOD ✓ clean (origin filter) · attention ✓ clean (origin filter) · Documents = sanctioned historical view (351 = exactly the 4 non-order money categories of the 606 backfill, FACT-020) · **finance summary KPIs ✗ NON-COMPLIANT — includes imported history (FACT-021, RISK-009, fix pending owner decision TASK-027)** · salesman Online "Completed" list ✗ (FACT-022/025) · driver route "Delivered" tile ✗ (FACT-024/025) — both live-observed, both from the unfiltered /api/portal/orders/all feed; remedied under the platform-wide standard TASK-026 (FACT-023, RISK-010) · warehouse dispatch ✓ (status-scoped) · driver Collect/EOD ✓ (server EOD override; latent unfiltered dead code noted in FACT-025)
