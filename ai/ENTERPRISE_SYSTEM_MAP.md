...
- **Data-view semantics (FACT-016, USER CONFIRMED):** Owner Overview = current LIVE operational activity only. Records tagged `origin:'july-import'` (FACT-008) are historical: available for reporting/reconciliation/audit views, excluded from live KPIs, and may appear combined with live figures only when the owner explicitly selects a Combined View (IMPLEMENTED 2026-07-21, FACT-027; UX spec ai/UX_AUDIT.md UXF-001). Live-audit evidence (FACT-018, 2026-07-21): Owner → Documents observed showing 351 imported records / AED 159,692.26 across the five money categories with July references — historical availability confirmed. **Surface compliance matrix (code-traced 2026-07-21, FACT-019/020/021):** owner home KPIs ✓ clean (client appstate) · Muhammed assistant ✓ clean (client appstate; observed zeros FACT-019) · EOD ✓ clean (origin filter) · attention ✓ clean (origin filter) · Documents = sanctioned historical view (351 = exactly the 4 non-order money categories of the 606 backfill, FACT-020) · finance summary KPIs ✓ live-default with explicit views (fixed 2026-07-21, FACT-027) · salesman Online ✓ live-default + labelled Historical Import/Combined views (FACT-027) · driver route Delivered tile ✓ (live-default feed, FACT-027) · warehouse dispatch ✓ (status-scoped) · driver Collect/EOD ✓ (server EOD override; latent unfiltered dead code noted in FACT-025). **Standard now authoritative: FACT-026/DEC-017; finance list endpoints (receipts, receipts/mine, payments, cheques, transfers/mine) live-default since v18 (FACT-030); guarded by backend/tools/test-live-standard.mjs (32 checks incl. per-role)**
